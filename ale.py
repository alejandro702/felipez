...
class Laser(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.current_time = 0
        self.speed = 500  # Velocidad del láser
    ...
    def update(self, dt):
        ...
        self.rect.x += self.speed * dt  # Mueve el láser hacia la derecha

        # Verificar colisiones del láser con los soldados
        colisionados = pygame.sprite.spritecollide(self, soldado_group, False)
        if colisionados:
            colisionados[0].kill_and_respawn()  # Respawn del soldado
            self.kill()  # Destruir el láser
            global score
...
def mostrar_puntaje():
    ...
    screen.blit(text, (10, 10))  # Dibuja el puntaje en la esquina superior izquierda

def mostrar_highscore():
    highscores = cargar_highscores()  # Leer el archivo de puntajes
    font = pygame.font.Font(None, 36)
    text = font.render(f"Highscore: {highscores['highscore']}", True, WHITE)
    screen.blit(text, (10, 50))  # Dibuja el highscore debajo del puntaje
